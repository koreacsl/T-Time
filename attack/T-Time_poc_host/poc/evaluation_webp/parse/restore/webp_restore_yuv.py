...
def generate_yuv_pixel_map(macroblocks, output_file="output_yuv.png"):
    ...
    for (x, y), values in macroblocks.items():
        ...
        u_thresholded = [200 if val > THRESHOLD_UV and val else 95 for val in u_ac_values] # u
        v_thresholded = [200 if val > THRESHOLD_UV and val else 120 for val in v_ac_values] # v
