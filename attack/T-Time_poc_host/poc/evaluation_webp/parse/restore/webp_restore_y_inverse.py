...
def generate_yuv_pixel_map(macroblocks, output_file="output_y_inverse.png"):
    ...
    for (x, y), values in macroblocks.items():
        ...
        u_thresholded = [128 if val > THRESHOLD_UV and val else 128 for val in u_ac_values] # u
        v_thresholded = [128 if val > THRESHOLD_UV and val else 128 for val in v_ac_values] # v
        ...
        for sub_idx, y_value in enumerate(y_ac_values):
            ...
            y_pixel = 0 if y_value <= THRESHOLD_Y else 255 # y
