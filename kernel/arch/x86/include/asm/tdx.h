...
u64 __seamcall_saved_ret_woomin(u64 fn, struct tdx_module_args *args, uint64_t* current_tsc, uint64_t* past_tsc_t);
...
#define seamcall_saved_ret_woomin(_fn, _args, _current_tsc, _past_tsc_t)  sc_retry(__seamcall_saved_ret_woomin, (_fn), (_args), (_current_tsc), (_past_tsc_t))
